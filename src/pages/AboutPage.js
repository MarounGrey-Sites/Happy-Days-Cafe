                    ...
                    <Col>
                        <div className='mx-auto mt-3 mb-5 text-center'>
                            <div className="w-75 mx-auto">
                                <p>At Happy Days Café, we believe that quality ingredients make for quality dining experiences. As a family-owned café specializing in coffee, churros, and desserts, we aim to serve each customer food and drink that brings a smile to their face.</p>
                                <p>We use freshly roasted beans from LAMILL coffee to provide quality lattés and specialty coffee drinks. For those with a sweet tooth, our churros take center stage. We make our churros fresh to order from scratch, offering them simply sugared or amped up with dipping sauces like our thick homemade hot chocolate. Feel free to stuff them with dulce de leche or sandwich some ice cream inside too!</p>
